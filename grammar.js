...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,4],$V1=[1,5],$V2=[1,11],$V3=[1,12],$V4=[5,8,11],$V5=[1,15],$V6=[7,13];
...
table: [{3:1,4:2,6:3,8:$V0,11:$V1},{1:[3]},{5:[1,6],6:7,8:$V0,11:$V1},{7:[1,8]},{9:[1,9]},{8:$V2,10:10,12:$V3},{1:[2,1]},{7:[1,13]},o($V4,[2,2]),{8:$V2,10:14,12:$V3},{7:[2,5],13:$V5},o($V6,[2,6]),o($V6,[2,7]),o($V4,[2,3]),{7:[2,4],13:$V5},{8:$V2,10:16,12:$V3},o($V6,[2,8])],
...
rules: [/^(?:\s+)/,/^(?:is\b)/,/^(?:show\b)/,/^(?:[0-9]+(\.[0-9]+)?)/,/^(?:[a-zA-Z]+)/,/^(?:\+)/,/^(?:\.)/,/^(?:$)/],
